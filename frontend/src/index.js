...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path='/' element={<App />}>
      ...
      <Route path='/search/:keyword' element={<Container><h4 className="container" style={{ fontWeight: "bold", letterSpacing: "2px", margin: "20px 0"  }}>Search Result: </h4><hr /><AllProducts /><AllServices /><AllBlogs /></Container>} />
      ...
      <Route path='' element={<AdminRoute />}>
        ...
        <Route path='/admin/bloglist/:pageNumber' element={<BlogListScreen />}/>
